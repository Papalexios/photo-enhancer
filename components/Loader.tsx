    ...
    <div className="flex flex-col items-center justify-center text-center p-8" aria-live="polite">
      <div className="relative flex items-center justify-center w-32 h-32 aurora-shimmer rounded-full">
        <div className="absolute inset-0 bg-gradient-to-br from-violet-500/20 to-purple-500/20 rounded-full blur-xl"></div>
         <svg className="w-12 h-12 text-violet-300 animate-pulse" fill="none" viewBox="0 0 24 24">
      ...
      <h3 className="mt-8 text-2xl font-bold text-white tracking-wide">Conjuring Masterpiece...</h3>
      <p className="mt-2 text-gray-300 animate-pulse min-h-[1.25rem]">{message}</p>
    </div>
  );
};